...
declare global {
    namespace alt1 {
         ...
         */
        function identifyAppUrl(url: string): unknown;
        /**
         ...
         * [Overlay] permission required.
         */
        function SetTaskbarProgress(type: number, progress: number): unknown;
        /**
         ...
         * [Overlay] permission required.
         */
        function setTitleBarText(text: string): unknown;
        /**
         ...
         * [Overlay] permission required.
         */
        function overLayClearGroup(group: string): unknown;
        /**
         ...
         * [Overlay] permission required.
         */
        function overLaySetGroup(group: string): unknown;
        /**
         ...
         * [Pixel] permission required.
         */
        function bindReadRightClickString(
            id: number,
            x: number,
            y: number
        ): string;
